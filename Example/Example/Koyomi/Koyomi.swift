...
final public class Koyomi: UICollectionView {
    ...
    fileprivate lazy var model: DateModel    = .init(calendarType)
    ...
    public init(frame: CGRect, calendarType: CalendarType, sectionSpace: CGFloat = 1.5, cellSpace: CGFloat = 0.5, inset: UIEdgeInsets = .zero, weekCellHeight: CGFloat = 25) {
